...
%}
    ...
    load("constants_feature_extraction_4.mat", "LENGTH", "BREADTH", "NUM_REGIONS", "NUM_RANGES_ROW", "STAR_MIN_PIXELS", "STAR_MAX_PIXELS", "PIXEL_SIZE");
    ...
    for i_row = 2:BREADTH
        ...
        [num_prev_row, arr_prev_row_data] = fe_line2prev(arr_row_data, num_ranges, arr_regions, arr_merge_regions, arr_region_data);
        ...
        [arr_region_data, arr_regions, num_tags, num_merge_regions, arr_merge_regions] = fe_compare_lines(arr_prev_row_data, arr_row_data, num_prev_row, num_ranges, num_tags);
    ...
    % adding star IDs
    arr_centroids(1:num_stars, 1) = 1:num_stars;
end